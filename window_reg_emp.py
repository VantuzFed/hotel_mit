...
from gui_files.ui_reg_emp import Ui_Form
...
class WindowRegisterEmp(QWidget):
    ...
    #     cur = self.obj.cursor()
    #     cur.execute(f'select * from clients where first_name = \'{self.fname}\' and last_name = \'{self.lname}\' and document_id = \'{self.doc_id}\'')
    #     res = cur.fetchone()
    #     print(res)
    #     try:
